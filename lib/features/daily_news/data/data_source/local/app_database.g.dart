...
class $AppDatabase extends AppDatabase {
  $AppDatabase([StreamController<String>? listener]) {
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `article` (`author` TEXT NOT NULL, `title` TEXT NOT NULL, `description` TEXT NOT NULL, `url` TEXT NOT NULL, `urlToImage` TEXT NOT NULL, `publishedAt` TEXT NOT NULL, `content` TEXT NOT NULL, PRIMARY KEY (`publishedAt`))');
  ...
  ArticleDao get articleDAO {
    return _articleDAOInstance ??= $ArticleDao(database, changeListener);
  }
}

class $ArticleDao extends ArticleDao {
  $ArticleDao(
    this.database,
    this.changeListener,
